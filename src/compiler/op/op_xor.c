/*
** op_xor.c for op_xor in /CPE_2015_corewar/src/compiler/op
**
** Made by Arthur ARNAUD
** Login   <arnaud_e@epitech.net>
**
** Started on  Thu Mar 24 04:04:54 2016 Arthur ARNAUD
** Last update Thu Mar 24 04:05:12 2016 Arthur ARNAUD
*/

#include "asm.h"

int	op_xor(t_action *action, char *str, t_pos *pos)
{
  int	i;
  char	c;
  char	type;
